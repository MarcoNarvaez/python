...
for row in range(len(tabla)):
    ...
    if tabla.loc[row,"ComitenteNueveCaracteres"] == ("888888888") or tabla.loc[row,"ComitenteNueveCaracteres"] == ("777777777"):
        ...
        tabla.loc[row,"Monto"] = float(tabla.loc[row,"Monto"])(str(tabla.loc[row,"Monto"])).rjust(7, '0')
        tabla.loc[row,"Exportar"] = "1'I'E'07465'000010000'05921" + "       '" + '%.2f' % tabla.loc[row,"Monto"] + "'0265'" + str(tabla.loc[row,"ComitenteNueveCaracteres"]) + "'N'00'" + dia + mes + "'0000'N"
